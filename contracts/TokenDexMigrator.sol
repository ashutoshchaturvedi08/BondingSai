...
contract TokenMigrator is AccessControl, LiquidityHelpers, ReentrancyGuard {
    ...
    constructor(address _positionManager, address _hook, address _permit2) {
  ...
  /// @notice Migrates liquidity from a bonding curve to a Uniswap V4 concentrated liquidity position
    ...
    /// @param tokenAmount  The balance amount of bonding curve 
    ...
    function migrate(
        ...
        require(tokenBalance > 0 && tokenBalance >= tokenAmount, "No tokens");
